...
(
    ...
    impedance_rate_windowed_values,
    timestamps_impedance_windowed_values,
) = (
    ...
    data["Impedance Rate Windowed Values"],
    data["Timestamps Impedance Windowed Values"] 
)
plt.close()
params = {
    "ytick.color": "black",
...
axs[0, 0].plot(
    np.array(timestamps_impedance_windowed_values),
    impedance_rate_windowed_values,
    color=colors[0],
    label="Impedance",
)
...
axs[0, 0].legend(loc="lower center", frameon=False, fontsize=8)
